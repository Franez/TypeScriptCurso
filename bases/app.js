...
(() => {
    ...
    const c = 10; //lo ideal es declarar el tipo de dato, esto limita los valores que puede tener la variable o constante
    let d; //como indica any puede ser cualquir tipo de dato por ejempo:
    d = 3.14; //un double
    d = true; //un booleano
    d = {}; //un objeto
    d = []; //un arreglo
